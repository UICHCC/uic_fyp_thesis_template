...
% Version: 1.0b
% Author: ECWU (Jack Wu)
% This is the final year project thesis LaTeX template for BNU-HKBU UIC Computer
% Science and Technology. When the template was created, the author referred to
% the LaTeX template of NAACL 2019 
% (https://naacl2019.org/downloads/naaclhlt2019-latex.zip) 
% and thesis template of the University of Nottingham 
% (https://github.com/imyueli/NottinghamThesisTemplate ).
% Besides, in the making of this template, the author also received the help of
% Dr. Goliath Li and Dr. Judy Feng.
% --------------------
...
\hypersetup{
  pdfauthor   = {\theauthor},
  pdftitle    = {UIC Final Year Project I Thesis LaTeX Template} % Change to your FYP project name
} 
...
\begin{document}
\input{confidential.tex}
\maketitle
\thispagestyle{empty}
\newpage
\clearpage\pagenumbering{Roman}
\setcounter{page}{2}
\input{frontpage/declaration.tex}
\newpage
...
\paragraph{Code}\mbox{}
\lstinputlisting[language=Python]{assets/code/test.py}
